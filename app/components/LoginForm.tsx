    ...
    return (
        <div className="font-light font-sans p-4 h-screen flex gap-20 flex-col justify-center items-center">
            <div className="relative flex flex-col justify-end items-center h-24 w-40">
                <h2 className="text-2xl text-custom-text">LOG IN</h2>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button
                type="submit"
                className="w-full text-2xl text-custom-text bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                LOG IN
                </button>
            </form>
